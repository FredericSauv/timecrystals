...
# noise average value obtained over 20 repetitions
...
# noise average value obtained over 1000 repetitions
...
# function to extract the optimal parameters obtained by the optimizer 
...
#-----------------------------------------------------------------------------#
# Test the different optimal parameters found 
#-----------------------------------------------------------------------------#
